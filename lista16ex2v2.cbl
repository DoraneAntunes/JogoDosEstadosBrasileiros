      ...
      *> Declaração do arquivo.                              *> Comando Select + Nome do arquivo do programa(nome dado pelo programador).
           select arqEstados assign to "arqEstados.dat"   *> Comando Assign (de associação) + nome do arquivo físico.
           ...
           file status is ws-fs-arqEstados.                  *> File status (o status da ultima operação) identificação de possíveis erros
                                                             *>  na indexação do programa.
       i-o-control.

      *>Divisão de Declaração de variáveis.
       data division.

      *> Declaração de variáveis do arquivo.
       file section.
       fd arqEstados.
       01  fd-estados.
      ...
      *>------------------------------------------------------------------------
      *>  Cadastro de jogadores, no máximo 4 jogadores
      *>------------------------------------------------------------------------
       cadastrar-jogadores section.
           ...
           perform until ws-sair = "V"
               ...
               if ws-nome-jogador <> space then  *> Tratamento para não permitir cadastro de usuários com spaces.
               perform descobrir-prox-ind-jog
                   if ws-ind-jog <= 4 then       *> Tratamento para evitar cadastro maior do que o permitido de jogadores.
                                                 *> Evitando estouro da tabela construída.
      ...
      *>           Conferência do resultado do jogador.
      ...
      *>------------------------------------------------------------------------
      *>   Descobrir a proxima posição de jogadores livre
      *>------------------------------------------------------------------------
      ...
      *>------------------------------------------------------------------------
      *>   Ordenação do resultado dos jogadores
      *>------------------------------------------------------------------------
